...
"""
    dashdock(;kwargs...)
    dashdock(children::Any;kwargs...)
    dashdock(children_maker::Function;kwargs...)


A DashDock component.
...
- `apiUrl` (String; optional): Custom API URL endpoint for key validation.
...
- `freeTabLimit` (Real; optional): Maximum number of tabs allowed in free version.
Default is 3.
...
Those elements have the following types:
  - `global` (optional): . global has the following type: lists containing elements 'borderAutoSelectTabWhenClosed', 'borderAutoSelectTabWhenOpen', 'borderClassName', 'borderEnableAutoHide', 'borderEnableDrop', 'borderMaxSize', 'borderMinSize', 'borderSize', 'enableEdgeDock', 'enableRotateBorderIcons', 'rootOrientationVertical', 'splitterEnableHandle', 'splitterExtra', 'splitterSize', 'tabBorderHeight', 'tabBorderWidth', 'tabClassName', 'tabCloseType', 'tabContentClassName', 'tabDragSpeed', 'tabEnableClose', 'tabEnableDrag', 'tabEnablePopout', 'tabEnablePopoutIcon', 'tabEnablePopoutOverlay', 'tabEnableRename', 'tabEnableRenderOnDemand', 'tabIcon', 'tabMaxHeight', 'tabMaxWidth', 'tabMinHeight', 'tabMinWidth', 'tabSetAutoSelectTab', 'tabSetClassNameTabStrip', 'tabSetEnableActiveIcon', 'tabSetEnableClose', 'tabSetEnableDeleteWhenEmpty', 'tabSetEnableDivide', 'tabSetEnableDrag', 'tabSetEnableDrop', 'tabSetEnableMaximize', 'tabSetEnableSingleTabStretch', 'tabSetEnableTabStrip', 'tabSetEnableTabWrap', 'tabSetMaxHeight', 'tabSetMaxWidth', 'tabSetMinHeight', 'tabSetMinWidth', 'tabSetTabLocation'.
Those elements have the following types:
...
Default: "top"
  - `borders` (optional): . borders has the following type: Array of lists containing elements 'location', 'children', 'autoSelectTabWhenClosed', 'autoSelectTabWhenOpen', 'className', 'config', 'enableAutoHide', 'enableDrop', 'maxSize', 'minSize', 'selected', 'show', 'size', 'type'.
Those elements have the following types:
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/box-sizing
  - `breakAfter` (a value equal to: 'left', 'right', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'all', 'always', 'avoid', 'avoid-column', 'avoid-page', 'avoid-region', 'column', 'page', 'recto', 'region', 'verso'; optional): The **`break-after`** CSS property sets how page, column, or region breaks should behave after a generated box. If there is no generated box, the property is ignored.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/break-after
  - `breakBefore` (a value equal to: 'left', 'right', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'all', 'always', 'avoid', 'avoid-column', 'avoid-page', 'avoid-region', 'column', 'page', 'recto', 'region', 'verso'; optional): The **`break-before`** CSS property sets how page, column, or region breaks should behave before a generated box. If there is no generated box, the property is ignored.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/break-inside
  - `captionSide` (a value equal to: 'top', 'bottom', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'block-end', 'block-start', 'inline-end', 'inline-start'; optional): The **`caption-side`** CSS property puts the content of a table's `<caption>` on the specified side. The values are relative to the `writing-mode` of the table.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/font-synthesis
  - `fontSynthesisPosition` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none'; optional): The **`font-synthesis-position`** CSS property lets you specify whether or not a browser may synthesize the subscript and superscript "position" typefaces when they are missing in a font family, while using `font-variant-position` to set the positions.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/font-synthesis-position
  - `fontSynthesisSmallCaps` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none'; optional): The **`font-synthesis-small-caps`** CSS property lets you specify whether or not the browser may synthesize small-caps typeface when it is missing in a font family. Small-caps glyphs typically use the form of uppercase letters but are reduced to the size of lowercase letters.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/font-synthesis-small-caps
  - `fontSynthesisStyle` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none'; optional): The **`font-synthesis-style`** CSS property lets you specify whether or not the browser may synthesize the oblique typeface when it is missing in a font family.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/font-synthesis-style
  - `fontSynthesisWeight` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none'; optional): The **`font-synthesis-weight`** CSS property lets you specify whether or not the browser may synthesize the bold typeface when it is missing in a font family.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/overflow-y
  - `overlay` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'none'; optional): The **`overlay`** CSS property specifies whether an element appearing in the top layer (for example, a shown popover or modal `<dialog>` element) is actually rendered in the top layer. This property is only relevant within a list of `transition-property` values, and only if `allow-discrete` is set as the `transition-behavior`.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/table-layout
  - `textAlign` (a value equal to: 'left', 'right', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'center', 'end', 'start', '-webkit-match-parent', 'justify', 'match-parent'; optional): The **`text-align`** CSS property sets the horizontal alignment of the inline-level content inside a block element or table-cell box. This means it works like `vertical-align` but in the horizontal direction.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/text-align
  - `textAlignLast` (a value equal to: 'left', 'right', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'center', 'end', 'start', 'justify'; optional): The **`text-align-last`** CSS property sets how the last line of a block or a line, right before a forced line break, is aligned.
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/text-underline-position
  - `textWrap` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'balance', 'nowrap', 'wrap', 'stable', 'pretty'; optional): The **`text-wrap`** CSS property controls how text inside an element is wrapped. The different values provide:
...
@,see,https,://developer.mozilla.org/docs/Web/CSS/white-space
  - `whiteSpaceCollapse` (a value equal to: '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'collapse', 'break-spaces', 'discard', 'preserve', 'preserve-breaks', 'preserve-spaces'; optional): The **`white-space-collapse`** CSS property controls how white space inside an element is collapsed.
...
**Initial value**: `50% 50%`
@,deprecated
  - `MozTextAlignLast` (a value equal to: 'left', 'right', '-moz-initial', 'inherit', 'initial', 'revert', 'revert-layer', 'unset', 'auto', 'center', 'end', 'start', 'justify'; optional): The **`text-align-last`** CSS property sets how the last line of a block or a line, right before a forced line break, is aligned.
...
state of the layout!
"""
function dashdock(; kwargs...)
        available_props = Symbol[:children, :id, :apiKey, :apiUrl, :colorScheme, :debugMode, :font, :freeTabLimit, :headers, :loading_state, :model, :popoutURL, :realtimeResize, :style, :supportsPopout, :useStateForModel]
        wild_props = Symbol[]
        return Component("dashdock", "DashDock", "dash_dock", available_props, wild_props; kwargs...)
end

dashdock(children::Any; kwargs...) = dashdock(;kwargs..., children = children)
dashdock(children_maker::Function; kwargs...) = dashdock(children_maker(); kwargs...)
